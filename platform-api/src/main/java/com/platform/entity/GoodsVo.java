...
public class GoodsVo implements Serializable {
    ...
    private Integer addTemplet;
    private BigDecimal typeValue;//大小
    // 冗余
    // 产品Id
    ...
    public Integer getAddTemplet() {
        return addTemplet;
    }

    public void setAddTemplet(Integer addTemplet) {
        this.addTemplet = addTemplet;
    }
